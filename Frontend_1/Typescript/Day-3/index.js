...
var greet = function (name, id) { return "Welcome ".concat(name, " your id : ").concat(id); };
var mygreet = greet("Megha", 20);
console.log(mygreet);
...
var ispallindrom = function (pallin_no) {
    var mypallin = pallin_no.split("").reverse().join("");
    return mypallin === pallin_no;
};
var res = console.log(ispallindrom("Megha"));
console.log(res);
