...
// greetMyfunc("Megha", 22);       // Output: Hello Megha, you are 22 years 
...
// type Person = {  //**this is the alias STUCTURE */
//   name: string;
//   age: number;
...
// **ex : DEFINE AN INTERFACEOR TYPE REPRESENTINF A PRODUCT WITH PROPERTIES FOR NAME ,PRICE,QUANTITY, CREATE A PRODUCT OBJ .
// type Product={
// name:string;
// price:number;
// quantity:number;
